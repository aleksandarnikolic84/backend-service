...
@Component
public class PremiumCompanyDataHandler extends CompanyDataHandler {

    private final CompanyClientRemote companyClientRemote;

    @Autowired
    public PremiumCompanyDataHandler(@Qualifier("premiumCompanyRemoteClient") CompanyClientRemote companyClientRemote,
    ...
    public CompanyHandlerType getType() {
        return CompanyHandlerType.PREMIUM;
    }
}
